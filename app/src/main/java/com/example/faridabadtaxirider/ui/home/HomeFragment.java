package com.example.faridabadtaxirider.ui.home;
...
import com.example.faridabadtaxirider.Callback.IFirebaseDriverInfoListener;
...
import com.example.faridabadtaxirider.Model.DriverInfoModel;
import com.example.faridabadtaxirider.Model.EventBus.SelectedPlaceEvent;
import com.example.faridabadtaxirider.Model.GeoQueryModel;
...
import com.example.faridabadtaxirider.RequestDriverActivity;
import com.example.faridabadtaxirider.Utils.LocationUtils;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback, IFirebaseFailedListener, IFirebaseDriverInfoListener {
    ...
    private static final double LIMIIT_RANGE = 10.0; //km
        ...
        if (locationCallback == null)
        {
            locationCallback = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    LatLng newPositon = new LatLng(locationResult.getLastLocation().getLatitude(),
                            locationResult.getLastLocation().getLongitude());
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(newPositon, 18f));
                    ...
                    if (previousLocation.distanceTo(currentLocation) / 1000 <= LIMIIT_RANGE)//Not over range
                        loadAvailableDrivers();
                    else {
                        //Do nothing
                    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Request permission to aff current location
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                        ...
                        mMap.setOnMyLocationButtonClickListener(new GoogleMap.OnMyLocationButtonClickListener() {
                            ...
                            public boolean onMyLocationButtonClick() {
                                ...
                                fusedLocationProviderClient.getLastLocation()
                                        .addOnFailureListener(e -> Snackbar.make(getView(), e.getMessage(), BaseTransientBottomBar.LENGTH_SHORT)
                                                .show())
                                        .addOnSuccessListener(location -> {
                            ...
                            Runnable runnable = () -> {
                                if (animationModel.getPolylineList() != null && animationModel.getPolylineList().size() > 1) {
                                    ...
                                    if (animationModel.getIndex() < animationModel.getPolylineList().size() - 2)//Reach destination
                                        animationModel.getHandler().postDelayed(this::addDriverMaker, 1500);
