package com.example.faridabadtaxidriver.ui.home;
...
import com.example.faridabadtaxidriver.Model.RiderModel;
import com.example.faridabadtaxidriver.Model.TripPlanModel;
...
import com.example.faridabadtaxidriver.Utils.LocationUtils;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    void onCompleteTripClick() {
        //first,updtae trip set done to true
    ...
    private void makeDriverOnline(Location location) {
        ...
        String saveCityName = cityName;//first save city name to variable
        ...
        {
            if (currentUserRef != null)// cheeck currentUserRef
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (!success)
                Log.e("AMIT_ERROR", "style parsing error");
        } catch (Resources.NotFoundException e) {
            Log.e("AMIT_ERROR", e.getMessage());
        }

        Snackbar.make(mapFragment.getView(), "Your're online", Snackbar.LENGTH_LONG)
                .show();
                                        ...
                                        if (dataSnapshot.exists()) {
                                            ...
                                            fusedLocationProviderClient.getLastLocation()
                                                    ...
                                                    .addOnSuccessListener(location -> {
                                                        ...
                                                        tripPlanModel.setDistanceText(event.getDistanceText());
                                                        tripPlanModel.setDurationText(event.getDurationText());
                                                        //value and fee
                                                        tripPlanModel.setDistanceValue(event.getDistanceValue());
                                                        tripPlanModel.setDurationValue(event.getDurationValue());
                                                        tripPlanModel.setTotalFee(event.getTotalFee());
                                                        ...
                                                        FirebaseDatabase.getInstance()
                                                            ...
                                                            setOfflineModelDriver(event, duration, distance);
    ...
    private void setOfflineModelDriver(DriverRequestReceived event, String duration, String distance) {
    ...
    private void setProcessLayout(boolean isProcess) {
        ...
        if (isProcess) {
            ...
            circularProgressBar.setProgress(0);
            txt_rating.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, R.drawable.ic_star_white24dp, 0);
        }
