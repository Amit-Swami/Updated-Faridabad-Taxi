            ...
            if (item.getItemId() == R.id.nav_sign_out)
            {
                ...
                builder.setTitle("Sign out")
                        ...
                        .setPositiveButton("SIGN OUT", (dialog, which) -> {
                            ...
                            Intent intent = new Intent(DriverHome.this,SplashScreenActivity.class);
                ...
                dialog.setOnShowListener(dialog1 ->  {
                    dialog.getButton(AlertDialog.BUTTON_POSITIVE)
                            .setTextColor(ContextCompat.getColor(DriverHome.this,android.R.color.holo_red_dark));
                    dialog.getButton(AlertDialog.BUTTON_NEGATIVE)
                            .setTextColor(ContextCompat.getColor(DriverHome.this,R.color.colorAccent));
