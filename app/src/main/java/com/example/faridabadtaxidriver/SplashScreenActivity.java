...
import com.example.faridabadtaxidriver.Model.DriverInfoModel;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        listener=myFirebaseAuth ->{
            ...
            if (user != null)
            {
                //update token while open the app
    ...
    private void goToHomeActivity(DriverInfoModel driverInfoModel) {
        ...
        startActivity(new Intent(SplashScreenActivity.this,DriverHome.class));
        finish();
    }
